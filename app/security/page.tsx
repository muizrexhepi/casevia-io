          ...
          <div className="max-w-3xl mx-auto prose prose-gray">
            <section className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Your trust is our top priority. We are committed to protecting
                the security and confidentiality of your data. This page
                outlines the measures we take to secure your interview files and
            ...
            <section className="space-y-4 mb-10">
              ...
              <div className="space-y-3">
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  minimum data necessary for them to perform their function. We
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                  ...
                  <li>
                    ...
                    <strong>OpenAI (GPT-4o)</strong> and{" "}
                    <strong>DeepSeek</strong> to extract insights and generate
            ...
            <section className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                uploaded interviews and generated case studies from your
                dashboard at any time. When you delete data, it is permanently
                removed from our active systems.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                For more details on data retention and your rights, please see
                our{" "}
                <Link
                  href="/privacy-policy"
            ...
            <section className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                If you have questions about our security practices or to report
