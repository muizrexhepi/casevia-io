      ...
      <div className="py-12 md:py-16 border-x container">
        <div className="max-w-3xl mx-auto prose prose-gray">
          ...
          <section className="space-y-4 mb-10">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                usage limits. Plan details and pricing are available on our
                pricing page.
              </p>
          ...
          <section className="space-y-4 mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              Exceeding these limits may result in service restrictions. Upgrade
          ...
          <section className="space-y-4 mb-10">
            ...
            <div className="space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Service, you grant us a limited license to process, analyze, and
                generate case studies from your content.
              </p>

              <h3 className="text-xl font-medium">6.2 Our Content</h3>
              <p className="text-muted-foreground leading-relaxed">
                The Service, including its design, features, and functionality,
                is owned by Casevia and protected by copyright, trademark, and
          ...
          <section className="space-y-4 mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              process your data in accordance with applicable data protection
              laws. Please review our Privacy Policy to understand how we
          ...
          <section className="space-y-4 mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              AI-generated content. You are responsible for reviewing and
          ...
          <section className="space-y-4 mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              You agree to indemnify and hold harmless Casevia from any claims,
          ...
          <section className="space-y-4 mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              the laws of the jurisdiction in which Casevia operates, without
