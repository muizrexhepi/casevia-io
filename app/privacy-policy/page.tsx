        ...
        <div className="max-w-3xl mx-auto prose prose-gray">
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
                ...
                <li>
                  ...
                  processed securely through Polar (we do not store full payment
                  card details)
                </li>
                <li>
                  <strong>Content:</strong> Audio/video files, transcripts, and
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                to Casevia, such as authentication providers or integration
                partners.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-4 mb-10">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              personal information within 90 days, unless retention is required
              by law.
            </p>
          </section>
