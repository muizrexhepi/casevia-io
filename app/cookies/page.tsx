          ...
          <div className="max-w-3xl mx-auto prose prose-gray">
            <section className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                tablet, or mobile) when you visit certain websites. They are
                used to "remember" you and your preferences, either for a single
                visit (a "session cookie") or for multiple repeat visits (a
                "persistent cookie").
              </p>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Our use of cookies is different depending on which Casevia
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                allows you to browse our site privately without needing to
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                the application to function correctly. We use them to:
              </p>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                they are loaded automatically and do not require a consent
                banner.
              </p>
            </section>
            ...
            <section className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                your login session securely. Without these, you would not be
                able to log in.
              </p>
            ...
            <section className="space-y-4 mb-10">
              ...
              <p className="text-muted-foreground leading-relaxed">
                You can, however, manage or delete cookies through your
                browser's settings. Please note that if you block all cookies
                (including strictly necessary ones), you will not be able to log
                in or use our application at <strong>app.casevia.io</strong>.
              </p>
            </section>
