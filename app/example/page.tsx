        ...
        <div className="max-w-3xl mx-auto prose prose-gray">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              across 40 countries, they were facing a critical challenge: their
              customer onboarding process was taking too long, leading to delays
              in time-to-value and increased churn during the trial period.
            </p>
            <p className="text-muted-foreground leading-relaxed">
              This case study explores how Streamline partnered with our team to
              completely redesign their onboarding experience, resulting in
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              ...
              taking an average of 14 days from signup to first productive use.
              This extended timeline was causing several problems:
            </p>
            <ul className="space-y-2 text-muted-foreground mb-4">
              ...
              <li className="flex items-start gap-2">
                <span className="text-primary mt-1">•</span>
                <span>
                  <strong>Support burden:</strong> The customer success team was
                  overwhelmed with basic setup questions
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-primary mt-1">•</span>
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
              We worked closely with Streamline's product and engineering teams
              to redesign the entire onboarding experience. The solution
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  in-app tutorials that guide users through key features as they
                  use them. This "learning by doing" approach dramatically
                  reduced the time to first value.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  We built automation tools that handle common setup tasks like
                  data import, team invitations, and initial configuration. What
                  previously required manual steps now happens automatically,
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 text-muted-foreground mb-6">
              <div className="flex items-start gap-3">
                ...
                <p>
                  Average onboarding time dropped from 14 days to just 5.6 days,
                  a 60% reduction
                </p>
              </div>
              <div className="flex items-start gap-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <p>
                  Trial abandonment rate decreased from 35% to 19%, meaning more
              ...
              <div className="flex items-start gap-3">
                ...
                <p>
                  Support tickets related to onboarding dropped by 70%, freeing
                  up the CS team for high-value activities
                </p>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-24 shrink-0 font-semibold text-primary">
                ...
                <p>
                  Annual cost savings from reduced support burden and increased
                  conversion rates
                </p>
              </div>
            </div>
            <div className="bg-muted p-6 rounded-lg border-l-4 border-primary my-6">
              <p className="text-foreground italic">
                "The new onboarding experience has been transformative. Not only
                are our customers getting value faster, but our team can now
                focus on strategic initiatives instead of hand-holding through
                setup. It's been a complete game-changer."
              </p>
              <p className="text-sm text-muted-foreground mt-2">
                — Sarah Chen, VP of Product at Streamline
              </p>
            ...
            <ul className="space-y-2 text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  manual steps wherever possible dramatically improves the user
                  experience
                </span>
              </li>
              <li className="flex items-start gap-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              accelerated growth. This case study demonstrates how investing in
              customer experience can yield substantial returns in both customer
      ...
      <div className="py-16 md:py-24 border-x container text-center space-y-6">
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <p className="text-lg text-muted-foreground">
            Transform your customer interviews into professional, publish-ready
